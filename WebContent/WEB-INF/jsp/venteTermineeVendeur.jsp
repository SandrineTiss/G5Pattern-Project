	...
	<div class="container-fluid bg-light">
		<div class="row g-0">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12 bg-light">
				<h2 id="titre">${article.getDerniereEnchere().getUtilisateur().getPseudo()} a remporté cette vente</h2>
			</div>
		</div>
		<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<div class="row g-0">
					...
					<c:if test="${article.getPrixVente()<=0}">
						<div class="col-lg-2 col-md-2 col-sm-6 col-6 bg-light center">
							<a href="${pageContext.request.contextPath}/RetraitEnchere?idArticle=${article.getNo_article()}"><input type="button" value ="Retrait effectué" class="btn btn-sm mb-2 shadow p-3"/></a>
						</div>
						<div class="d-lg-none d-md-none col-sm-6 col-6 bg-light center">
							
							<a href="${pageContext.request.contextPath}/ContacterGagnant?gagnant=${article.getDerniereEnchere().getUtilisateur().getPseudo()}"><input type="button" value ="Contacter ${article.getDerniereEnchere().getUtilisateur().getPseudo()}" name="contacter" class="btn btn-sm mb-2 shadow p-3"/></a>
						</div>
					</c:if>
