...
-- Passage du mdp en VARCHAR(40) pour pouvoir le crypter en SHA1
...
-- on delete de l'utilisateur, on a choisi de set null, pour conserver la base intacte concernant les articles 
